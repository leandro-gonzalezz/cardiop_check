const contactInfo = [
  {
    title: "Ubicación",
    value: "Formosa",
    subValue: "Ciudad de Formosa, Argentina",
    icon: (
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-primary to-lightblue text-white rounded-full flex items-center justify-center mb-4 shadow-lg">
                    {info.icon}
                  </div>
