          ...
          <div className="col-span-1">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-white font-semibold group-hover:text-accent transition-colors">Instagram</span>
                <span className="text-gray-300 text-sm group-hover:text-gray-200 transition-colors">@cardiocheckfsa</span>
              </a>
